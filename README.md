...
echo "Generating MD5 checksums..."
find . -maxdepth 1 -name '*.fastq.gz' -print0 \
  | xargs -0 -n1 -P8 md5sum > GSE_local_checksums.md5.tmp \
  && mv GSE_local_checksums.md5.tmp GSE_local_checksums.md5
echo "Checksum generation complete."

# grab ENA database checksum
